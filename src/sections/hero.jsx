function Hero() {
  ...
  <div className = "hero-container flex flex-col items-start mx-auto">
    ...
    <h1 className = "hero-baslik text-6xl font-bold leading-tight mb-60 ml-[80px] font-[ınter]">
      <span className="hero-span ">CREATIVE THINKER</span>
      <br />
      <span className="hero-span ">MINIMALISM LOVER</span>
    </h1>

    <p className="mr-[20px] mt-30  w-[553px] absolute top-[489px] left-[90px] font-inter text-base font-normal leading-[28px] text-left font-inter text-[18px]">Hi, I’m Nida. I’m a full-stack developer. If you are looking for a <br /> Developer who to craft solid and scalable frontend products with <br /> great user experiences. Let’s shake hands with me.</p>


    <div className="w-[476px] absolute top-[235px] letf-[798px] rounded-l-[18px] ml-[70rem] mt-[3rem]">
